...
window.addEventListener("DOMContentLoaded", function (event) {
  ...
  refreshList(); //When a card tag is clicked

  function tagClicked(i) {
    //Get tag value
    var cardText = cardTag[i].innerHTML; //Create filter tag

    var newTag = document.createElement("li");
    newTag.innerHTML = "<p>" + cardText + '</p><span class="close-span">×</span>';
    return function () {
  ...
  document.getElementById("js-clear-tags").addEventListener("click", function () {
